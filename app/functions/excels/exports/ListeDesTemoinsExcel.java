...
public class ListeDesTemoinsExcel extends Excel{
	...
	public ListeDesTemoinsExcel(Map<String,String> info, List<ListeDesTemoins> temoins) throws IOException{
		super();
		...
		titre+=crLf+" ("+temoins.size()+" témoin(s) pour "+ListeDesTemoins.getSomme(temoins)+" témoignage(s))";
		...
		for(ListeDesTemoins temoin : temoins){
			if(ecritAGauche){
